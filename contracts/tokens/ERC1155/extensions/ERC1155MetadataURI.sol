...
abstract contract ERC1155MetadataURI is IERC1155MetadataURI, ERC1155 {
  ...
  // **************************************
    ...
    // ***********************
      /**
      * @notice Returns the URI for token type `id_`.
      *
      ...
      */
      function uri(uint256 id_) public view virtual override isValidSeries(id_) returns (string memory) {
        return bytes(_baseUri).length > 0 ?
          string(abi.encodePacked(_baseUri, _toString(id_))) :
          _toString(id_);
      }
    // *******************
  // **************************************
