...
abstract contract ERC1155 is IERC1155Errors, IArrayErrors, IERC1155 {
  ...
  // **************************************
    ...
    * @param operator_ address that wants to manage the tokens
    */
  ...
  // **************************************
    ...
    // ************
      /**
      * @notice Transfers `amounts_` amount(s) of `ids_` from the `from_` address to the `to_` address specified
      *   (with safety call).
      * 
      ...
      */
      ...
      /**
      * @notice Transfers `amount_` amount of an `id_` from the `from_` address to the `to_` address specified
      *   (with safety call).
      * 
      * @param from_ Source address
      * @param to_ Target address
