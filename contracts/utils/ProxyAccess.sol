...
abstract contract ProxyAccess {
  ...
  // *****           ERRORS           *****
  // **************************************
    /// @dev Thrown when adding a proxy that is already set.
    error ProxyAccess_ALREADY_REGISTERED();
    /// @dev Thrown when removing a proxy that doesn't exist.
  ...
  // *****     STORAGE VARIABLES      *****
  // **************************************
    /// @dev list of registered proxies.
  ...
  // **************************************
    ...
    /// 
    /// @return isRegistered whether `operator_` is allowed to operate on behalf of `tokenOwner_` or not
    function isRegisteredProxy(address tokenOwner_, address operator_) public view returns (bool isRegistered) {
