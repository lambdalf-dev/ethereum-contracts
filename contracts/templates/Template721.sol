...
abstract contract Template721 is 
  ...
  // **************************************
    ...
    */
    function mintPrivate(uint256 qty_, uint256 alloted_, Proof calldata proof_)
      public
      virtual
      payable
      isState(PRIVATE_SALE)
      isWhitelisted(msg.sender, PRIVATE_SALE, alloted_, proof_, qty_)
    {
      if (qty_ == 0) {
