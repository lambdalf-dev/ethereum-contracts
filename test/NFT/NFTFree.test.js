const ARTIFACT            = require( `../../artifacts/contracts/mocks/NFT/Mock_NFTFree.sol/Mock_NFTFree.json` )
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeNFTFreeAtDeploy( deployFixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeNFTFreeAfterSettingProxy( proxyFixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeNFTFreeAfterSettingStateToOpen( saleFixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeNFTFreeAfterMint( mintFixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeNFTFreeAfterMintingOut( mintOutFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
})
