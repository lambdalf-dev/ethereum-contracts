...
// **************************************
	...
	} = require( `../../test/ERC1155/behavior.ERC1155MetadataURI` )
// **************************************
...
// **************************************
	...
	const TEST_DATA = {
		...
		// METADATA
		INIT_BASE_URI               : `https://api.example.com/metadata/`,
		// INTERFACES
		INTERFACES : [
			`IERC165`,
			`IERC1155`,
...
// **************************************
	async function shouldBehaveLikeERC1155AtDeployTime ( fixture, TEST, CONTRACT  ) {
		...
		shouldBehaveLikeIERC1155MetadataURIAfterCreatingSeries( fixture, TEST, CONTRACT )
