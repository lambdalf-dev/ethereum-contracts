const ARTIFACT = require( `../../artifacts/contracts/mocks/utils/Mock_Whitelist_MerkleMultiple.sol/Mock_Whitelist_MerkleMultiple.json` )
// **************************************
// *****           IMPORT           *****
// **************************************
...
// **************************************
	...
	const CONTRACT_INTERFACE = {
		NAME : `Mock_Whitelist_MerkleMultiple`,
		METHODS : {
...
// **************************************
	...
	async function shouldBehaveLikeMock_Whitelist_MerkleMultipleBeforeSettingWhitelist ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_MerkleMultiple before setting whitelist`, function () {
	...
	async function shouldBehaveLikeMock_Whitelist_MerkleMultipleAfterSettingWhitelist1 ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_MerkleMultiple after setting whitelist 1`, function () {
			if ( TEST_ACTIVATION.CORRECT_INPUT ) {
				beforeEach( async function () {
					const {
						test_user1,
	...
	async function shouldBehaveLikeMock_Whitelist_MerkleMultipleAfterSettingWhitelist2 ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_MerkleMultiple after setting whitelist 2`, function () {
			if ( TEST_ACTIVATION.CORRECT_INPUT ) {
				beforeEach( async function () {
					const {
						test_user1,
	...
	async function shouldBehaveLikeMock_Whitelist_MerkleMultipleAfterSetting2Whitelists ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_MerkleMultiple after setting 2 whitelists`, function () {
			if ( TEST_ACTIVATION.CORRECT_INPUT ) {
				beforeEach( async function () {
					const {
						test_user1,
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeMock_Whitelist_MerkleMultipleBeforeSettingWhitelist( noAccessFixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeMock_Whitelist_MerkleMultipleAfterSettingWhitelist1( access1Fixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeMock_Whitelist_MerkleMultipleAfterSettingWhitelist2( access2Fixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeMock_Whitelist_MerkleMultipleAfterSetting2Whitelists( allAccessFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
})
