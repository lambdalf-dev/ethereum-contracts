...
// **************************************
	...
	} = require( `../utils/behavior.IInitializable` )
// **************************************
...
// **************************************
	...
	async function shouldBehaveLikeMock_IInitializable ( fixture, TEST, CONTRACT ) {
				...
				describe( CONTRACT.METHODS.initialize.SIGNATURE, function () {
					if ( TEST.METHODS.initialize ) {
						it( `Should revert when already initialized`, async function () {
							await shouldRevertWhenAlreadyInitialized(
								contract.initialize()
							)
						})
					}
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeMock_IInitializable( fixture, TEST_DATA, CONTRACT )
	}
})
