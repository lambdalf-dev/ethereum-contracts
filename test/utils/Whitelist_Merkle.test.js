...
// **************************************
	async function noAccessFixture () {
		...
		const test_accesslist1 = JSON.parse( JSON.stringify( TEST_DATA.ACCESS_LIST_1 ) )
		...
		const test_accesslist2 = JSON.parse( JSON.stringify( TEST_DATA.ACCESS_LIST_2 ) )
...
// **************************************
	...
	async function shouldBehaveLikeMock_Whitelist_MerkleBeforeSettingWhitelist ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_Merkle before setting whitelist`, function () {
			beforeEach( async function () {
				const {
					test_user1,
					test_user2,
	...
	async function shouldBehaveLikeMock_Whitelist_MerkleAfterSettingWhitelist1 ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_Merkle after setting whitelist 1`, function () {
			beforeEach( async function () {
				const {
					test_user1,
					test_user2,
	...
	async function shouldBehaveLikeMock_Whitelist_MerkleAfterSettingWhitelist2 ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_Merkle after setting whitelist 2`, function () {
			beforeEach( async function () {
				const {
					test_user1,
					test_user2,
	...
	async function shouldBehaveLikeMock_Whitelist_MerkleAfterSetting2Whitelists ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_Merkle after setting 2 whitelists`, function () {
			beforeEach( async function () {
				const {
					test_user1,
					test_user2,
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeMock_Whitelist_MerkleBeforeSettingWhitelist( noAccessFixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeMock_Whitelist_MerkleAfterSettingWhitelist1( access1Fixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeMock_Whitelist_MerkleAfterSettingWhitelist2( access2Fixture, TEST_DATA, CONTRACT_INTERFACE )
		shouldBehaveLikeMock_Whitelist_MerkleAfterSetting2Whitelists( allAccessFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
})
