const ARTIFACT = require( `../../artifacts/contracts/mocks/utils/Mock_Whitelist_Merkle.sol/Mock_Whitelist_Merkle.json` )
// **************************************
// *****           IMPORT           *****
// **************************************
...
// **************************************
	...
	async function shouldBehaveLikeMock_Whitelist_Merkle ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Whitelist_Merkle`, function () {
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeMock_Whitelist_Merkle( fixture, TEST_DATA, CONTRACT_INTERFACE )
	}
})
