const ARTIFACT            = require( `../../artifacts/contracts/mocks/tokens/Mock_Consec_ERC721Batch.sol/Mock_Consec_ERC721Batch.json` )
...
// **************************************
	...
	function shouldBehaveLikeMock_Consec_ERC721BatchBeforeMint ( fixture, TEST, CONTRACT ) {
	...
	function shouldBehaveLikeMock_Consec_ERC721BatchAfterMint ( fixture, TEST, CONTRACT ) {
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeMock_Consec_ERC721BatchBeforeMint( noMintFixture, TEST_DATA, CONTRACT_INTERFACE )
		...
		shouldBehaveLikeMock_Consec_ERC721BatchAfterMint( mintFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
})
