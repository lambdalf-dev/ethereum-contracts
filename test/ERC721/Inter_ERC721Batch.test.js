...
// **************************************
	...
	function shouldBehaveLikeMock_Inter_ERC721BatchBeforeMint ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Inter_ERC721Batch before any token is minted`, function () {
	...
	function shouldBehaveLikeMock_Inter_ERC721BatchAfterMint ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Inter_ERC721Batch after minting some tokens`, function () {
			if ( TEST_ACTIVATION.CORRECT_INPUT ) {
				beforeEach( async function () {
					const {
						test_user1,
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeMock_Inter_ERC721BatchBeforeMint( noMintFixture, TEST_DATA, CONTRACT_INTERFACE )
		...
		shouldBehaveLikeMock_Inter_ERC721BatchAfterMint( mintFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
})
