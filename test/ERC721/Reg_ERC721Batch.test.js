...
// **************************************
	...
	function shouldBehaveLikeMock_Reg_ERC721BatchBeforeMint ( fixture, TEST, CONTRACT ) {
	...
	function shouldBehaveLikeMock_Reg_ERC721BatchAfterMint ( fixture, TEST, CONTRACT ) {
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeMock_Reg_ERC721BatchBeforeMint( noMintFixture, TEST_DATA, CONTRACT_INTERFACE )
		...
		shouldBehaveLikeMock_Reg_ERC721BatchAfterMint( mintFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
})
