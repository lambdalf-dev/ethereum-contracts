const ARTIFACT            = require( `../../artifacts/contracts/mocks/tokens/Mock_Consec_ERC721BatchBurnable.sol/Mock_Consec_ERC721BatchBurnable.json` )
...
// **************************************
	...
	function shouldBehaveLikeMock_Consec_ERC721BatchBurnableBeforeMint ( fixture, TEST, CONTRACT ) {
	...
	function shouldBehaveLikeMock_Consec_ERC721BatchBurnableAfterMint ( fixture, TEST, CONTRACT ) {
		describe( `Should behave like Mock_Consec_ERC721Batch after minting some tokens`, function () {
			if ( TEST_ACTIVATION.CORRECT_INPUT ) {
				beforeEach( async function () {
					const {
						test_user1,
...
describe( TEST_DATA.NAME, function () {
	if ( TEST_ACTIVATION[ TEST_DATA.NAME ] ) {
		...
		shouldBehaveLikeMock_Consec_ERC721BatchBurnableBeforeMint( noMintFixture, TEST_DATA, CONTRACT_INTERFACE )
