...
// **************************************
	...
	const CONTRACT_INTERFACE = {
		NAME : `Mock_Consec_ERC721BatchBurnable`,
		METHODS : {
			// **************************************
			// *****           PUBLIC           *****
			// **************************************
	...
	const TEST_DATA = {
		// TEST NAME
		NAME : `Consec_ERC721BatchBurnable`,
		// SUPPLY
...
// **************************************
	...
	function shouldBehaveLikeMock_Consec_ERC721BatchBurnableAtDeploy ( fixture, TEST, CONTRACT ) {
		shouldBehaveLikeERC721BatchBeforeMint( fixture, TEST, CONTRACT )

		describe( `Should behave like Mock_Consec_ERC721BatchBurnable before any token is minted`, function () {
	...
	function shouldBehaveLikeMock_Consec_ERC721BatchBurnableAfterMint ( fixture, TEST, CONTRACT ) {
	...
	function shouldBehaveLikeMock_Consec_ERC721BatchBurnableAfterBurn ( fixture, TEST, CONTRACT ) {
...
describe( TEST_DATA.NAME, function () {
	...
	if ( true ) {
		shouldBehaveLikeMock_Consec_ERC721BatchBurnableAtDeploy( deployFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
	if ( true ) {
		shouldBehaveLikeMock_Consec_ERC721BatchBurnableAfterMint( mintFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
	if ( true ) {
		shouldBehaveLikeMock_Consec_ERC721BatchBurnableAfterBurn( burnFixture, TEST_DATA, CONTRACT_INTERFACE )
	}
})
