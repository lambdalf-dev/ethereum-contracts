...
// **************************************
  ...
  // ********************
    contract Unit_Mint is Deployed {
      function test_unit_erc721BatchBurnable_emit_Transfer_event_when_minting_via_mint() public {
    ...
    contract Unit_Mint2309 is Deployed {
      function test_unit_erc721BatchBurnable_emit_ConsecutiveTransfer_event_when_minting_via_mint2309() public {
        address operator = ALICE.addr;
    ...
    contract Unit_SetBaseUri is Deployed {
      function test_unit_erc721BatchBurnable_set_base_uri() public {
  ...
  // ***********
    contract Unit_Approve is Deployed {
      function test_unit_erc721BatchBurnable_revert_when_token_dont_exist() public {
        address operator = ALICE.addr;
      ...
      function test_unit_erc721BatchBurnable_revert_when_operator_not_approved() public {
      ...
      function test_unit_erc721BatchBurnable_revert_when_approving_token_owner() public {
        address operator = ALICE.addr;
      ...
      function test_unit_erc721BatchBurnable_revert_when_trying_to_approve_burned_token() public {
        address operator = ALICE.addr;
        address approvedAccount = OPERATOR.addr;
        uint256 tokenId = TARGET_TOKEN;
        _burnFixture();
      ...
      function test_unit_erc721BatchBurnable_emit_Approval_event_when_caller_is_token_owner() public {
        address operator = ALICE.addr;
        address approvedAccount = OPERATOR.addr;
        uint256 tokenId = TARGET_TOKEN;
        _mintFixture();
    ...
    contract Unit_SafeTransferFrom is Deployed {
      ...
      function test_unit_erc721BatchBurnable_revert_when_recipient_is_address_zero() public {
        address operator = ALICE.addr;
        address tokenOwner = ALICE.addr;
      ...
      function test_unit_erc721BatchBurnable_revert_when_from_dont_own_token() public {
        address operator = ALICE.addr;
      ...
      function test_unit_erc721BatchBurnable_revert_when_receiver_is_non_receiver_contract() public {
      ...
      function test_unit_erc721BatchBurnable_revert_when_receiver_contract_returns_unexpected_value() public {
      ...
      function test_unit_erc721BatchBurnable_revert_when_receiver_contract_reverts_with_custom_error() public {
        Mock_ERC721Receiver receivingContract = new Mock_ERC721Receiver(
      ...
      function test_unit_erc721BatchBurnable_revert_when_receiver_contract_reverts_with_message() public {
        Mock_ERC721Receiver receivingContract = new Mock_ERC721Receiver(
          type(IERC721Receiver).interfaceId,
      ...
      function test_unit_erc721BatchBurnable_revert_when_receiver_contract_reverts_without_message() public {
        Mock_ERC721Receiver receivingContract = new Mock_ERC721Receiver(
          type(IERC721Receiver).interfaceId,
      ...
      function test_unit_erc721BatchBurnable_revert_when_receiver_contract_panics() public {
        Mock_ERC721Receiver receivingContract = new Mock_ERC721Receiver(
          type(IERC721Receiver).interfaceId,
      ...
      function test_unit_erc721BatchBurnable_revert_when_trying_to_transfer_burned_token() public {
        address operator = ALICE.addr;
        address tokenOwner = ALICE.addr;
        address recipient = RECIPIENT.addr;
        uint256 tokenId = TARGET_TOKEN;
      ...
      function test_unit_erc721BatchBurnable_emit_Transfer_event_when_caller_is_token_owner() public {
        address operator = ALICE.addr;
        address tokenOwner = ALICE.addr;
        address recipient = RECIPIENT.addr;
        uint256 tokenId = TARGET_TOKEN;
      ...
      function test_unit_erc721BatchBurnable_emit_Transfer_event_when_caller_is_individually_approved() public {
        address operator = OPERATOR.addr;
        address tokenOwner = ALICE.addr;
        address recipient = RECIPIENT.addr;
        uint256 tokenId = TARGET_TOKEN;
      ...
      function test_unit_erc721BatchBurnable_emit_Transfer_event_when_caller_is_approved_for_all() public {
        address operator = OPERATOR.addr;
        address tokenOwner = ALICE.addr;
        address recipient = RECIPIENT.addr;
        uint256 tokenId = TARGET_TOKEN;
    ...
    contract Unit_SetApprovalForAll is Deployed {
      function test_unit_erc721BatchBurnable_revert_when_approving_self() public {
        address operator = ALICE.addr;
        address approvedAccount = ALICE.addr;
      ...
      function test_unit_erc721BatchBurnable_emit_ApprovalForAll_when_approving_other() public {
        address operator = ALICE.addr;
        address approvedAccount = OPERATOR.addr;
        bool isApproved = true;
        vm.prank(operator);
      ...
      function test_unit_erc721BatchBurnable_emit_ApprovalForAll_when_disproving_other() public {
        address operator = ALICE.addr;
        address approvedAccount = OPERATOR.addr;
  ...
  // ***********************
    contract Burn is Deployed {
      ...
      function test_unit_erc721BatchBurnable_revert_when_trying_to_burn_burned_token() public {
        address operator = ALICE.addr;
        uint256 tokenId = TARGET_TOKEN;
        _burnFixture();
        vm.prank(operator);
...
// **************************************
  ...
  // ***********
    contract Unit_BalanceOf is Deployed {
      function test_unit_erc721BatchBurnable_revert_when_checking_balance_of_zero_address() public {
        address tokenOwner = address(0);
        vm.expectRevert(IERC721.IERC721_INVALID_TOKEN_OWNER.selector);
        testContract.balanceOf(address(0));
      }
      function test_unit_erc721BatchBurnable_balance_of_non_token_owner_is_zero() public {
        address tokenOwner = OPERATOR.addr;
        _mintFixture();
        assertEq(
          testContract.balanceOf(tokenOwner),
      ...
      function test_unit_erc721BatchBurnable_balance_of_token_owners_is_accurate() public {
        _mintFixture();
        assertEq(
    ...
    contract Unit_GetApproved is Deployed {
      function test_unit_erc721BatchBurnable_revert_when_requesting_approval_status_of_token_zero() public {
        uint256 tokenId = 0;
        _mintFixture();
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.getApproved(tokenId);
      }
      function test_unit_erc721BatchBurnable_revert_when_requesting_approval_status_of_non_existant_token() public {
        uint256 tokenId = TARGET_TOKEN;
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.getApproved(tokenId);
      }
      function test_unit_erc721BatchBurnable_revert_when_requesting_approval_status_of_burned_token() public {
        uint256 tokenId = TARGET_TOKEN;
        _burnFixture();
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.getApproved(tokenId);
      }
      function test_unit_erc721BatchBurnable_individual_approval_status_of_freshly_minted_token_is_address_zero() public {
        uint256 tokenId = TARGET_TOKEN;
        _mintFixture();
        assertEq(
          testContract.getApproved(tokenId),
    ...
    contract Unit_IsApprovedForAll is Deployed {
      function test_unit_erc721BatchBurnable_approval_for_all_status_is_false_by_default() public {
        address tokenOwner = ALICE.addr;
        address operator = OPERATOR.addr;
        assertFalse(
    ...
    contract Unit_OwnerOf is Deployed {
      function test_unit_erc721BatchBurnable_revert_when_requesting_ownership_of_token_zero() public {
        uint256 tokenId = 0;
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.ownerOf(tokenId);
      }
      function test_unit_erc721BatchBurnable_revert_when_requesting_ownership_of_non_existant_token() public {
        uint256 tokenId = TARGET_TOKEN;
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.ownerOf(tokenId);
      }
      function test_unit_erc721BatchBurnable_revert_when_requesting_ownership_of_burned_token() public {
        uint256 tokenId = TARGET_TOKEN;
        _burnFixture();
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.ownerOf(tokenId);
      }
      function test_unit_erc721BatchBurnable_ownership_of_existing_tokens_is_accurate() public {
        _mintFixture();
        assertEq(
  ...
  // *********************
    contract Unit_TokenByIndex is Deployed {
      function test_unit_erc721BatchBurnable_revert_when_requesting_token_at_non_existant_index() public {
      ...
      function test_unit_erc721BatchBurnable_token_by_index_is_accurate() public {
        uint256 index = TARGET_INDEX;
        _mintFixture();
        assertEq(
          testContract.tokenByIndex(index),
    ...
    contract Unit_TokenOfOwnerByIndex is Deployed {
      ...
      function test_unit_erc721BatchBurnable_revert_when_requesting_index_of_non_owned_token() public {
        address tokenOwner = OPERATOR.addr;
        uint256 index = TARGET_INDEX;
        _mintFixture();
      ...
      function test_unit_erc721BatchBurnable_token_of_owner_by_index_is_accurate() public {
        _mintFixture();
        assertEq(
    ...
    contract Unit_TotalSupply is Deployed {
      function test_unit_erc721BatchBurnable_initial_total_supply_is_accurate() public {
        assertEq(
      ...
      function test_unit_erc721BatchBurnable_total_supply_is_accurate_after_minting_some_tokens() public {
        _mintFixture();
        assertEq(
          testContract.totalSupply(),
          MINTED_SUPPLY,
      ...
      function test_unit_erc721BatchBurnable_total_supply_is_accurately_reduced_after_burning() public {
        _burnFixture();
        assertEq(
          testContract.totalSupply(),
  ...
  // *******************
    contract Unit_Name is Deployed {
      function test_unit_erc721BatchBurnable_name_is_accurate() public {
        assertEq(
          testContract.name(),
          NAME,
          "invalid name"
    ...
    contract Unit_Symbol is Deployed {
      function test_unit_erc721BatchBurnable_symbol_is_accurate() public {
        assertEq(
          testContract.symbol(),
          SYMBOL,
          "invalid ticker"
    ...
    contract Unit_TokenURI is Deployed {
      function test_unit_erc721BatchBurnable_revert_when_requesting_uri_of_token_zero() public {
        uint256 tokenId = 0;
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.tokenURI(tokenId);
      }
      function test_unit_erc721BatchBurnable_revert_when_requesting_uri_of_non_existant_token() public {
        uint256 tokenId = TARGET_TOKEN;
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.tokenURI(tokenId);
      }
      function test_unit_erc721BatchBurnable_revert_when_requesting_uri_of_burned_token() public {
        uint256 tokenId = TARGET_TOKEN;
        _burnFixture();
        vm.expectRevert(IERC721.IERC721_NONEXISTANT_TOKEN.selector);
        testContract.tokenURI(tokenId);
      }
      function test_unit_erc721BatchBurnable_token_uri_is_accurate() public {
        uint256 tokenId = TARGET_TOKEN;
        _mintFixture();
        assertEq(
          keccak256(abi.encodePacked(testContract.tokenURI(tokenId))),
